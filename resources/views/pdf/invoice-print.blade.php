...
<div class="toolbar no-print">
    ...
    <a class="primary" href="{{ route('documents.invoice.pdf', $invoice) }}">{{ __('Download PDF') }}</a>
    <a href="{{ route('documents.invoice.csv', $invoice) }}">{{ __('Download CSV') }}</a>
    <a href="{{ route('documents.invoice.xlsx', $invoice) }}">{{ __('Download Excel') }}</a>
</div>
